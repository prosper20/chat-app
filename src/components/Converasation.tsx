...
const Converasation: FC<ConverasationProps> = ({
  ...
  const dateFormatted = lastMessageDate?.toLocaleTimeString("en-US", {
    hour: "numeric",
    minute: "numeric",
  });
        ...
        <div className="relative">
          <div className="w-12 h-12 rounded-full overflow-hidden flex-shrink-0 flex items-center justify-center bg-purple-100 text-purple-700">
            {conversationWithSelf ? (
              ...
              <img
                src={recipient.avatar || "https://res.cloudinary.com/dhqv8cxqz/image/upload/v1709890679/Frame_1743_up0e8x.svg"}
                alt="profile picture"
